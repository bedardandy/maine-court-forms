...
| `name` | Text | 1 |  |
| `name of adoptee` | Text | 1 |  |
| `name of legal parents 1` | Text | 1 |  |
| `name of legal parents 2` | Text | 1 |  |
| `I admit that I am a biological parent of the child` | CheckBox | 1 | Check if applicable |
| `I neither admit nor deny that I am a biological parent of the child` | CheckBox | 1 | Check if applicable |
| `request` | CheckBox | 1 | Check if applicable |
| `do not request that my child be entitled to inherit` | CheckBox | 1 | Check if applicable |
| `Dated` | Text | 1 | MM/DD/YYYY format |
| `Personally appeared the above named putative parent` | Text | 1 |  |
| `Text1` | Text | 1 |  |
