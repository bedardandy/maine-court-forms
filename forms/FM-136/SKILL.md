...
| `Defendant` | Text | 1 |  |
| `DivorceJudgment` | CheckBox | 1 | Check if applicable |
| `Order` | CheckBox | 1 | Check if applicable |
| `date` | Text | 1 | MM/DD/YYYY format |
| `IMPORTANTNOTICETO` | Text | 1 |  |
| `name of obligor` | Text | 1 |  |
| `sum` | Text | 1 |  |
| `per` | Text | 1 |  |
| `name of obligee` | Text | 1 |  |
| `Datemmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `Magistrate` | CheckBox | 1 | Check if applicable |
| `JudgeMaineDistrictCourt` | CheckBox | 1 | Check if applicable |
