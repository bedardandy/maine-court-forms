...
| `The abovenamed juvenile whose date of birth is mmddyyyy` | Text | 1 | MM/DD/YYYY format |
...
| `The Department of Corrections because the disposition involved either commitment to the` | CheckBox | 1 | Check if applicable |
| `The office of the prosecuting attorney because the disposition included a payment of restitution` | CheckBox | 1 | Check if applicable |
| `The juvenile or the juveniles attorney` | CheckBox | 1 | Check if applicable |
| `If this notice is being filed by the juvenile or the juveniles attorney the attorney served a copy of this` | CheckBox | 1 | Check if applicable |
| `notice on the office of the prosecuting attorney on mmddyyyy` | Text | 1 |  |
| `Date mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `undefined` | Text | 1 |  |
| `Printed Name` | Text | 1 |  |
| `Bar Number if applicable` | Text | 1 | Attorney bar number |
