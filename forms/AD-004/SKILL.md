...
| `This matter involves an adoption petition filed pursuant to 18C MRS  9301 and the minor adoptee` | CheckBox | 1 | Check if applicable |
| `I am the adoptee named above I was born on` | Text | 1 |  |
| `and I am` | Text | 1 |  |
| `I understand that a petition to adopt me has been filed by` | Text | 1 |  |
| `petitioners who will become my legal` | Text | 1 |  |
| `and for the change of my name` | CheckBox | 1 | Check if applicable |
| `This matter involves a confirmatory adoption petition filed pursuant to 18C MRS  9316 and the` | CheckBox | 1 | Check if applicable |
| `I am the adoptee named above I was born on_2` | Text | 1 |  |
| `and I am_2` | Text | 1 |  |
| `I understand that a petition to adopt me has been filed by_2` | Text | 1 |  |
| `petitioners who isare my parents or my` | Text | 1 |  |
| `Dated` | Text | 1 | MM/DD/YYYY format |
| `Text1` | Text | 1 |  |
| `Printed Name of Adoptee` | Text | 1 |  |
