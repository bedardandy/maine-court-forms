...
| `Defendant` | Text | 1 |  |
| `Otherparty` | Text | 1 |  |
| `Witness signature electronic or actual 1` | Text | 1 | Physical signature required |
| `Plaintiff signature electronic or actual` | Text | 1 | Physical signature required |
| `Date mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `Witness signature electronic or actual 2` | Text | 1 | Physical signature required |
| `Defendant signature electronic or actual` | Text | 1 | Physical signature required |
| `Date mmddyyyy_2` | Text | 1 | MM/DD/YYYY format |
| `Witness signature electronic or actual 3` | Text | 1 | Physical signature required |
| `Party signature electronic or actual` | Text | 1 | Physical signature required |
