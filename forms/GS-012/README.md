...
Official blank form: [GS-012](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=GS-012) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `GS-012.pdf` | Blank fillable source form |
