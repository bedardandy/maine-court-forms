# FM-088 — Instructions — Motion to Modify
...
Official blank form: [FM-088](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=FM-088) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `FM-088.pdf` | Blank fillable source form |
