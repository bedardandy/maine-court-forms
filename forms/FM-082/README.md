# FM-082 — Family Matter Summary Sheet (FM-002)

- **Category:** Family
- **Court:** District Court / Family Division
- **Pages:** 4  |  **Fillable fields:** 0
- **Revision:** unknown
...
Official blank form: [FM-082](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=FM-082) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `FM-082.pdf` | Blank fillable source form |
