...
| `PLAINTIFFS PREJUDGMENT MOTION TO DISMISS COMPLAINT` | Text | 1 |  |
| `hereby requests that the complaint for Protection` | Text | 1 |  |
| `prejudice and that any Temporary Order based on the complaint be terminated for the following reasons 1` | Text | 1 |  |
| `automatically terminated` | Text | 1 |  |
| `Text1` | Text | 1 |  |
