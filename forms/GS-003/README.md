...
Official blank form: [GS-003](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=GS-003) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `GS-003.pdf` | Blank fillable source form |
