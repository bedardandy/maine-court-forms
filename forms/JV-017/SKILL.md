...
| `date of the hearing is mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `This waiver was executed before a judge` | CheckBox | 1 | Check if applicable |
