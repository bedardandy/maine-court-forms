...
| `I` | Text | 1 |  |
| `A caseworkercounselor with` | Text | 1 |  |
| `has received counseling from me regarding` | Text | 1 |  |
| `for the purpose of adoption` | Text | 1 |  |
| `insert name here` | Text | 1 |  |
| `Dated` | Text | 1 | MM/DD/YYYY format |
| `Name and Title of Counselor` | Text | 1 |  |
| `Personally appeared the abovenamed` | Text | 1 |  |
| `and made oath that the foregoing statements are true under penalty of` | Text | 1 |  |
