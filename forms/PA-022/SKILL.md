...
| `MODIFY` | CheckBox | 1 | Check if applicable |
| `EXTINGUISH FINAL PROTECTION ORDER` | CheckBox | 1 | Check if applicable |
| `1 Plaintiff Contact Information` | Text | 1 |  |
| `undefined_2` | Text | 1 |  |
| `If different mailing address` | Text | 1 | Mailing/street address |
| `2 Defendant Contact Information` | Text | 1 |  |
| `undefined_3` | Text | 1 |  |
| `If different mailing address_2` | Text | 1 | Mailing/street address |
| `plaintiff` | CheckBox | 1 | Check if applicable |
| `defendant` | CheckBox | 1 | Check if applicable |
| `the Order for Protection from AbuseHarassment dated mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `requests that` | Text | 1 |  |
| `modified as follows 1` | Text | 1 |  |
| `MAINE JUDICIAL BRANCH 1` | Text | 2 |  |
| `19A MRS  4111 Do not complete this section if you are the defendant` | CheckBox | 2 | Check if applicable |
| `The plaintiff` | Text | 2 |  |
| `Protection from AbuseHarassment dated mmddyyyy 1` | Text | 2 | MM/DD/YYYY format |
| `Protection from AbuseHarassment dated mmddyyyy 2` | Text | 2 | MM/DD/YYYY format |
