...
# CR-250 — Maine Treatment Court Plea Agreement

**Form Number:** CR-250, Rev. 03/25
**Pages:** 3
**Fillable Fields:** 18
**Category:** Criminal
...
| `and I` | CheckBox | 2 | Check if applicable |
| `am not` | CheckBox | 2 | Check if applicable |
| `a Successful completion of the Maine Treatment Court 1` | Text | 2 |  |
| `b Unsuccessful completion of the Maine Treatment Court 1` | Text | 2 |  |
