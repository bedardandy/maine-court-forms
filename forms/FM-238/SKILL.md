...
| `The Maine District Court is located at` | Text | 1 |  |
| `Service in Hand or by Mail You must file with the court 1 the Acknowledgment of Receipt of Summons and` | CheckBox | 1 | Check if applicable |
| `Service by Certified Mail with Restricted Delivery You must file with the court the green postcard you get back` | CheckBox | 1 | Check if applicable |
| `Service by Sheriff The sheriff will complete the Return of Service section on this form and return the completed` | CheckBox | 2 | Check if applicable |
