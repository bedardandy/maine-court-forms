...
| `I relinquished the firearms andor dangerous weapons listed and described below to an individual whose name` | CheckBox | 1 | Check if applicable |
| `and address is` | Text | 1 | Mailing/street address |
| `I have attached a list describing each weapon relinquished or` | CheckBox | 1 | Check if applicable |
| `The description of each weapon relinquished is as follows` | CheckBox | 1 | Check if applicable |
| `1_3` | Text | 1 |  |
| `2_3` | Text | 1 |  |
| `3` | Text | 1 |  |
| `undefined_2` | Text | 1 |  |
| `2 Date the weapons waswere relinquished mmddyyyy` | Text | 1 | MM/DD/YYYY format |
...
| `I have no firearms or dangerous weapons in my possession or control` | CheckBox | 1 | Check if applicable |
| `the court` | CheckBox | 1 | Check if applicable |
| `the law enforcement agency designated on the order within 24 hours` | CheckBox | 1 | Check if applicable |
