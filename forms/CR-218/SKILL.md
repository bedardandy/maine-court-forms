...
|-----------|------|------|-------|
| `Defendant` | Text | 1 |  |
| `Defendants DOB mmddyyyy` | Text | 1 |  |
...
| `Text1` | Text | 1 |  |
| `1 Defendant was convicted of the following crime of name of crime` | Text | 1 | Defendant's name |
| `on mmddyyyy` | Text | 1 |  |
| `Date mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `undefined` | Text | 1 |  |
| `1` | Text | 1 |  |
| `2` | Text | 1 |  |
| `Defendants Attorney and Maine Bar No` | Text | 1 | Attorney bar number |
