# MJ-015 — Judgment Creditor

**Form Number:** MJ-015, Rev. 09/15
**Pages:** 1
**Fillable Fields:** 13
...
| `employment information pursuant to 14 MRS  3126A8 to be served on` | Text | 1 |  |
| `installment order dated mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `The judgment debtor currently owes the judgment creditor` | Text | 1 |  |
| `undefined` | Text | 1 |  |
