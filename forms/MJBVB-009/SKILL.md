...
| `v` | Text | 1 |  |
| `violations` | Text | 1 |  |
| `The violations Iwish to amendare` | Text | 1 |  |
| `amendment` | Text | 1 |  |
| `Iwouldlike to amendthe violations to read` | Text | 1 |  |
| `reason` | Text | 1 |  |
| `The reason for this requestis` | Text | 1 |  |
| `date1` | Text | 1 | MM/DD/YYYY format |
| `printed name` | Text | 1 |  |
| `agency/department` | Text | 1 |  |
