...
| `On mmddyyyy` | Text | 1 |  |
| `the defendant` | Text | 1 |  |
| `The order of commitment was transmitted to the State Forensic Service on mmddyyyy` | Text | 1 |  |
| `As of mmddyyyy` | Text | 1 |  |
| `Text1` | Text | 1 |  |
| `Text2` | Text | 1 |  |
| `Text3` | Text | 1 |  |
| `Text4` | Text | 1 |  |
