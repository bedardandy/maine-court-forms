# FM-108 — Important Notice about Mediation
...
This notice form provides required notification in family proceedings.
...
Official blank form: [FM-108](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=FM-108) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `FM-108.pdf` | Blank fillable source form |
