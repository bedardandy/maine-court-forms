...
| `Pursuant to 29A MRS  24541 the juvenile as a result of the operation or attempted` | CheckBox | 2 | Check if applicable |
| `Murder` | CheckBox | 2 | Check if applicable |
| `Felony murder or` | CheckBox | 2 | Check if applicable |
| `Manslaughter and caused the death of a human being` | CheckBox | 2 | Check if applicable |
| `Pursuant to 29A MRS  24542 the juvenile as a result of the operation or` | CheckBox | 2 | Check if applicable |
| `Murder_2` | CheckBox | 2 | Check if applicable |
| `Felony murder or_2` | CheckBox | 2 | Check if applicable |
| `Manslaughter` | CheckBox | 2 | Check if applicable |
| `a CMV` | CheckBox | 2 | Check if applicable |
| `used in the transport of hazardous materials andor` | CheckBox | 2 | Check if applicable |
| `a bus carrying 15 passengers` | CheckBox | 2 | Check if applicable |
