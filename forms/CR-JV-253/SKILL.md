...
| `V` | Text | 1 |  |
| `the defendant in the abovecaptioned matter who is subject to` | Text | 1 |  |
| `Date mmddyyyy` | Text | 1 | MM/DD/YYYY format |
| `to a correctional facility this transfer will occur as soon as practicable upon termination` | Text | 1 |  |
| `Department of Health and Human Services` | Text | 1 |  |
| `V` | Text | 1 |  |
| `the defendant in the abovecaptioned matter who is subject to` | Text | 1 |  |
