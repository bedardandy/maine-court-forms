...
| `V 1` | Text | 1 |  |
| `V 2` | Text | 1 |  |
| `19A MRS  18011805` | Text | 1 |  |
| `petition for grandparent or greatgrandparent visitation` | Text | 1 |  |
| `I have attached an affidavit with the specific facts addressing whether the petitioners should be` | CheckBox | 1 | Mailing/street address |
| `Enter an order denying petitioners petition for grandparent or greatgrandparent visitation` | CheckBox | 1 | Check if applicable |
...
| `punishable by up to 5 years in prison and a fine of up to 5000 if I give false information to the court` | Text | 1 |  |
| `undefined_4` | Text | 1 |  |
| `CLEAR FORM` | Button | 1 |  |
| `Respondent Attorney` | Text | 2 |  |
| `Respondent` | Text | 2 |  |
...
| `Personally appeared the above named respondent` | Text | 2 |  |
