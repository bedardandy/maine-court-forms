# FM-056 — Real Estate Certificate

- **Category:** Family
- **Court:** Maine Judicial Branch
- **Pages:** 1  |  **Fillable fields:** 36
- **Revision:** unknown
- **Automation:** recipe

## Purpose

Certificate of real estate ownership required when either party has interest in real property.

## Source

Official blank form: [FM-056](https://mjbportal.courts.maine.gov/CourtForms/FormsLists/DownloadForm?strFormNumber=FM-056) (Maine Judicial Branch forms portal).

## Files in this folder

| File | What it is |
|---|---|
| `FM-056.pdf` | Blank fillable source form |
