...
| `Defendant` | Text | 1 |  |
| `name/location of court` | Text | 1 |  |
| `Date` | Text | 1 | MM/DD/YYYY format |
| `Date 2` | Text | 1 | MM/DD/YYYY format |
| `Date 3` | Text | 1 | MM/DD/YYYY format |
| `return to which court` | Text | 1 |  |
| `Date 4` | Text | 1 | MM/DD/YYYY format |
