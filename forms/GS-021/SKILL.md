...
| `1 I` | Text | 1 |  |
| `interim` | CheckBox | 1 | Check if applicable |
| `final appointment of the proposed guardian and state as follows` | CheckBox | 1 | Check if applicable |
| `Name and birthdate of the minor child` | Text | 1 | MM/DD/YYYY format |
| `Name of minor childs tribe and childs enrollment number` | Text | 1 |  |
| `My tribal enrollment number` | Text | 1 |  |
| `My address 1` | Text | 1 | Mailing/street address |
| `My address 2` | Text | 1 | Mailing/street address |
| `I understand the nature of a minor guardianship and I agree that the establishment of a minor` | Text | 1 |  |
...
| `Judge Probate Court` | CheckBox | 1 | Check if applicable |
