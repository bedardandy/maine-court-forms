...
# CR-259 — Request for Notice to the Secretary of State

**Form Number:** CR-259, Rev. 05/22
**Pages:** 1
**Fillable Fields:** 23
**Category:** Criminal
...
This notice form provides required notification in criminal proceedings.
...
| `assault` | CheckBox | 1 | Check if applicable |
| `aggravated assault` | CheckBox | 1 | Check if applicable |
| `elevated aggravated assault` | CheckBox | 1 | Check if applicable |
| `criminal` | CheckBox | 1 | Check if applicable |
| `reckless conduct` | CheckBox | 1 | Check if applicable |
| `bodily injury or` | CheckBox | 1 | Check if applicable |
| `serious bodily injury to another person` | CheckBox | 1 | Check if applicable |
| `created a substantial risk of serious bodily injury or` | CheckBox | 1 | Check if applicable |
| `placed another person in fear of imminent bodily` | CheckBox | 1 | Check if applicable |
| `a CMV over` | CheckBox | 1 | Check if applicable |
| `used in the transport of hazardous materials andor` | CheckBox | 1 | Check if applicable |
| `a bus carrying 15 passengers or more` | CheckBox | 1 | Check if applicable |
