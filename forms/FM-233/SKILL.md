# FM-233 — Defendant’s Answer to Plaintiff’s Complaint

**Form Number:** FM-233, Rev. 08/20
**Pages:** 2
**Fillable Fields:** 29
**Category:** Family
...
This is the defendant’s answer to plaintiff’s complaint for form filed to initiate a family case in Maine court.
...
| `1 Defendant admits paragraphs` | Text | 1 |  |
| `for determination of de facto parentage` | Text | 1 |  |
| `I have attached an affidavit describing the specific facts addressing whether the plaintiff has a de` | CheckBox | 1 | Mailing/street address |
| `Enter an order denying plaintiffs complaint to be adjudicated de facto parent` | CheckBox | 1 | Check if applicable |
| `Award reasonable attorney fees andor` | CheckBox | 1 | Check if applicable |
| `Other` | CheckBox | 1 | Check if applicable |
| `undefined` | Text | 1 |  |
| `1` | Text | 1 |  |
| `2` | Text | 1 |  |
| `I hereby declare that the above statements are true to the best of my knowledge and belief I` | CheckBox | 1 | Check if applicable |
| `information to the court` | Text | 1 |  |
| `undefined_2` | Text | 1 |  |
| `Text1` | Text | 1 |  |
| `CLEAR FORM` | Button | 1 |  |
| `Defendant Attorney` | Text | 2 |  |
| `Defendant` | Text | 2 |  |
