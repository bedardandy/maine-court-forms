...
| `The attorney for the State` | Text | 1 |  |
| `is currently in the custody of the Department of Corrections is being held at Long Creek Youth Development Center and` | Text | 1 |  |
| `respectfully represent that` | Text | 1 |  |
| `is awaiting hearing on mmddyyyy` | Text | 1 |  |
| `into` | Text | 1 |  |
